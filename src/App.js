      ...
      <div className="App">
        <>
          <Navbar expand="lg" bg="warning" variant="light">
            <Container>
              <Navbar.Brand href="/">
              <img src={logo} width="200px" height="50px" className="" alt="" />
                &nbsp;
              </Navbar.Brand>
              ...
              <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="me-auto">
                  ...
                  <Nav.Link as={Link} to="/profile" style= {{fontSize:"20px"}}>About Me</Nav.Link>
                </Nav>
                <Nav>
                  {account ? (
                    <Nav.Link
                    ...
                    <Button onClick={web3Handler} variant="danger">Connect Wallet</Button>
                  )}
                </Nav>
              </Navbar.Collapse>
            </Container>
